...
import tocruz.exceptions.InvalidOptionException;
import tocruz.exceptions.InvalidTypeItemException;
import tocruz.interfaces.*;
import ed.interfaces.*;
import tocruz.items.Item;
...
import tocruz.personagens.ToCruz;
import ed.queue.LinkedQueue;
import ed.stacks.LinkedStack;
import ed.arraylist.ArrayUnordered;
...
public class Simulacoes implements SimulacoesInt, Comparable<Simulacoes> {
     ...
     */
    private static final Scanner sc = Consola.SCANNER;
